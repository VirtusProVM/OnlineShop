...
@WebServlet(name = "ShowAddProductFormServlet", urlPatterns = {"/admin/showAddProduct"})
public class ShowAddProductFormServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/admin/add-product-form.jsp");
